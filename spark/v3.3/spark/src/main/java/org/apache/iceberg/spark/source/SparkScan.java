...
abstract class SparkScan extends SparkBatch implements Scan, SupportsReportStatistics, SupportsReportPartitioning {
  ...
  static class ReadTask implements InputPartition, Serializable, HasPartitionKey {
    ...
    public InternalRow partitionKey() {
      return new GenericInternalRow(new Object[] {table().spec().fields().get(0)});
    }
  }
}
